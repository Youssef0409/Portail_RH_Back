...
import com.example.stage.exception.InvalidEntityException;
import com.example.stage.token.Token;
import com.example.stage.token.TokenRepository;
import com.example.stage.token.TokenType;
    ...
    public AuthenticationResponse register(RegisterRequest request) {
        if (request.getRole() == Role.Employee) {
            var user = User.builder()
                    ...
                    .dateNaissance(request.getNaissance())
